"""
`behave-odoo` is a Python package that provides a collection of helper functions designed to simplify the process of writing behave tests for Odoo applications. 
